...
public class HTTPRequest implements HttpServletRequest {
     ...
     * synchronized.
     */
    protected ConcurrentHashMap parameters = null;
    ...
    /**
     * Set the name of the ts (virtual host) to process this request.
     *
     * @param name The ts name
     */
    public void setServerName(String name) {
        this.serverName = name;
    }
    /**
     * Set the port number of the ts to process this request.
     *
     * @param port The ts port
     */
