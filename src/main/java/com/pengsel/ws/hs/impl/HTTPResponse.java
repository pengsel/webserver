...
import com.pengsel.ws.util.CookieUtil;
...
*/
    ...
    synchronized (cookies) {
      ...
      while (items.hasNext()) {
        ...
        outputWriter.print(CookieUtil.getCookieHeaderName(cookie));
        outputWriter.print(": ");
        outputWriter.print(CookieUtil.getCookieHeaderValue(cookie));
        outputWriter.print("\r\n");
      }
    }
